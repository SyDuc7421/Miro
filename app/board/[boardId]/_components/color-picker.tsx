...
import { RGBColorToHexColor } from "@/lib/utils";
...
export const ColorPicker = ({ onChange }: ColorPickerProps) => {
  return (
    <div className="border-neural-200 mr-2 flex max-w-[164px] flex-wrap items-center gap-2 border-r pr-2">
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: RGBColorToHexColor(color),
        }}
        aria-hidden
      />
    </div>
